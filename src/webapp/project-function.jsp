...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${path}/skin/images/tbg.gif">&nbsp;功能列表&nbsp;</td>
</tr>
<tr align="center" bgcolor="#FAFAF1" height="22">
    ...
    <c:forEach items="${pageInfo.list}" var="fun">
...
<tr align="right" bgcolor="#EEF4EA">
	<td height="36" colspan="12" align="center">
        ...
        <a href='${path}/fun/showAllInfo?pageNum=1'>首页</a>
        <a href='${path}/fun/showAllInfo?pageNum=${pageInfo.prePage}'>上一页</a>
        <a href='${path}/fun/showAllInfo?pageNum=${pageInfo.nextPage}'>下一页</a>
        <a href='${path}/fun/showAllInfo?pageNum=${pageInfo.pages}'>尾页</a>
