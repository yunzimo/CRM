...
<li><a href='${path}/pro/showAllInfo' target='main'>基本信息管理</a> </li>
<li><a href='${path}/ana/showAllInfo' target='main'>需求分析管理</a> </li>
<li><a href='project-model.jsp' target='main'>模块管理</a> </li>
<li><a href='${path}/fun/showAllInfo' target='main'>功能管理</a> </li>
...
<li><a href='showAllCustomers' target='main'>客户信息</a> </li>
</ul></dd></dl>
